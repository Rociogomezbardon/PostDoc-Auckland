...
locations = [ 'office4','office3', 'office2', 'office1', 'kitchen', 'library']
boolean = ['true', 'false']
runCount = None
...
def createRandomInitialConditions():
	initial_conditions = []
	initial_conditions_index = random.randrange(1,577,1)
	current_index = 0
...
def createConstrainedInitialConditions():
	...
	book1_location = 'office3'
	book2_location = 'office3'
	in_handBook1 = 'false'
	in_handBook2 = 'false'
	initial_conditions = [locked_or_not, robot_location , book1_location , book2_location, in_handBook1, in_handBook2]
