...
class Controller_ToA(object):
	...
	def getActivity(self,initial_conditions,goal):
		...
		if(answer == "{}\n"): 
			...
			activity_name = int(((plan_in_actions[24:]).split(')'))[0])
	...
	def __updateActivitiesList(self,plan,goal):
		...
		if(activity_length not in [13] or len(self.activities_list) == 10): return False, 0, activity_length
		...
		new_activity.append('activity_length('+activity_name+','+str(activity_length)+').')
