...
%%%%%%%%%
%% GOAL GOES HERE
goal(I) :- holds(coarse_in_hand(rob1,book1),I),-holds(coarse_in_hand(rob1,book3),I),holds(coarse_loc(rob1,kitchen),I),-holds(coarse_in_hand(rob1,book2),I),-holds(coarse_in_hand(rob1,book4),I),holds(coarse_loc(book1,kitchen),I),holds(coarse_loc(book4,office1),I),holds(coarse_loc(book3,library),I),holds(coarse_loc(book2,library),I).
...
holds(coarse_loc(book4,office1),0).
