	...
	def __init__(self):
		...
		with open(self.domain_info_file) as f:
			for line in f:
				...
				if is_abstract_sorts_line: self.abstract_signature_lines.append(line)
				if is_abstract_attributes_line: self.abstract_attributes_lines.append(line)
				if is_defaults_line: self.defaults_lines.append(line)
...
#		print self.actions_param_and_exec_conditions_dic
	...
	def init_file_names(self):
		...
		self.domain_info_file = pre_ASP_folder + 'domain_signatures.txt'

		self.file_name_pre_pre_ASP_abstract_domain = pre_pre_ASP_folder + 'pre_pre_ASP_abstract_domain.txt'
		self.file_name_pre_pre_ASP_ToI_domain = pre_pre_ASP_folder + 'pre_pre_ASP_ToI_domain.txt'
		self.file_name_pre_pre_ASP_refined_domain = pre_pre_ASP_folder + 'pre_pre_ASP_refined_domain.txt'

		self.file_name_preASP_ToI_planning = pre_ASP_folder + 'preASP_ToI.txt' # Used for astract planning and diagnosis with ToI
		self.file_name_preASP_abstract_domain = pre_ASP_folder + 'preASP_abstract_domain.txt' # used for updating controller abstract belief
		...
		self.asp_toi_explaining_file = ASP_folder + 'ToI_Explaining.sp'
		...
		self.asp_abstract_state_file = ASP_folder + 'Abstract_State.sp'
	...
	def init_files_markers(self):
		...
		self.defaults_marker = '%% DEFAULTS GO HERE'
